                ...
                if(packageMatch != null) {
                    if(packageMatch[0] === text) {
                        ...
                        if(packageAndTypeMatch != null && packageAndTypeMatch[0] === text) {
                            ...
                            console.log("package with ONLY colon" + packageAndTypeMatch2[0]);
                            ...
                            if(packageAndTypeAndActionMatch != null && packageAndTypeAndActionMatch[0] === text) {
                                console.log("package with everything" + packageAndTypeAndActionMatch[0]);
                                ...
                                console.log("package with everything" + packageAndTypeAndActionMatch2[0]);
