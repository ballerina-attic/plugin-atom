...
export class Dictionary {
    ...
    add(packageStructure, packageContent) {
            ...
            if(matchPackageContent !== null) {
                ...
                while(nativeActionMatch !== null) {
                    ...
                    if(matchedConstructor !== null) {
                        ...
                        // console.log("constructor: " + constructorObject.constructor);
                        constructorObject.type = matchedConstructor[2];
                        // console.log("type: " + constructorObject.type);
                    }
                    ...
                    while(matchedAction !== null) {
                        ...
                        // console.log("returnType: " + actionObject.returnType + ", function: " + actionObject.function);
                ...
                while(nativeFunctionMatch !== null) {
                    ...
                    // console.log("function: " + functionObject.function + ", returnType: " + functionObject.returnType);
                ...
                if(property === packageName) {
                    ...
                    if(functionPrefix.length == 0) {
                        ...
                        if(null != node.constructorList) {
                            // console.log("constructorList not null");
                            for (var i=0; i < node.constructorList.length; i++) {
                                // console.log(node.constructorList[i]);
                        ...
                        if(null != node.functionList) {
                            for (var i=0; i < node.functionList.length; i++) {
                                // console.log(node.functionList[i]);
                        ...
                        if(null != node.typeconvertorList) {
                            for (var i=0; i < node.typeconvertorList.length; i++) {
                                // console.log(node.typeconvertorList[i]);
                                resultArray.push(node.typeconvertorList[i].returnType + "|" +node.typeconvertorList[i].typeconvertor);
                            }
                        }
